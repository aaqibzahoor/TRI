          ...
          <div className="col-xl-8 col-lg-8 col-12">
            <div className="blog-content-wrap">
              ...
              <div className="blog-quote-wrap">
                ...
                <div className="blog-quote-text">
                  <p>
                    ...
                    odit aut fugit, sed quia conse quuntur doloresvolup tatem
              ...
              <h3 className="mt-20 mb-30">
                Home repair and interior design services
              </h3>
              <p>
                Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit
                aut fugit, sed quia consequuntur magni dolores eos qui ratione
                ...
                <div className="single-comments-inner">
                  ...
                  <div className="comments-content">
                    ...
                    <p>
                      ...
                      esse cillum dolore eu occaecat cupidatat non proident,
            ...
            <div className="blog-sidebar">
              ...
              <div className="blog-category">
                ...
                <ul>
                  ...
                  <li>
                    <i className="las la-angle-double-right"></i>
                    <Link href="/blog">Home Renovation</Link>
                  </li>
                </ul>
              </div>
              <div className="recent-post-wrap">
                ...
                <div className="single-recent-post">
                  ...
                  <div className="recent-post-content">
                    ...
                    <a href="#">
                      <h6>
                        From forest to furnishing: the story of solid wood
                      </h6>
                    </a>
                  </div>
                </div>
