            ...
            <div className="row align-items-center">
              <div className="col-xl-5 col-lg-5 col-md-6">
                <div className="footer-content-wrap">
                  ...
                  >
                    Transform the look and feel of your existing home by
                    replacing tired timber or outdated aluminium windows with
                    our modern, high-performance systems. We focus on upgrades
                    that immediately improve thermal insulation, noise
